                            ...
                            <div v-if="questionShow.type==12">
                                <van-radio-group v-model="radio" v-on:change="onChange">
                                    <div v-for="(item,index) in questionShow.answers" class="answer-css" v-bind:key="item.answer">
                                        ...
                                        <div class="input-clsss" v-if="index==2" style="margin-top: 20px;">
                                            <van-cell-group>
...
<script>
    import questionsOut from '../../../assets/js/queUser.js'
    ...
    export default {
        ...
        data(){
            return{
                ...
                questionHadAns: 0,
                questionShowIndex: 0,
                questionNum: questionsOut.usernear.qNum,
                questionShow: {
                ...
                questions: questionsOut.usernear.questions,
                answers: [],
        ...
        methods:{
            onChange:function(dataMsg) {
                ...
                if (this.questionHadAns > this.questionShowIndex) {
                    ...
                    this.radio= dataMsg
                    if(dataMsg=="其他"||dataMsg=="未直接参与诊治肺炎患者"||dataMsg=="是，您原本的工作单位"
                        ||dataMsg=="确诊，医院隔离"||dataMsg=="疑似，医院隔离"){
                        console.log("选择其他");
            ...
            send: function (message) {
                ...
                this.$axios.post(urlNew,{
                    ...
                    if(response.status=="200"){
                        ...
                        that.$router.push('/pages/scaleV3')
                    }
