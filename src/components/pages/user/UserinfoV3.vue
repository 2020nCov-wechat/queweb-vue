                ...
                <div class='myService'>
                    ...
                    <div class='serviceList acea-row row-middle'>
                        ...
                        <div class="suggess-css">
                            ...
                            <div v-if="questionShow.type==11">
                                <div  class="answer-css" v-on:click="showJobBottom">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            send: function (message) {
                ...
                this.$axios.post(urlNew,{
                    ...
                    if(response.status=="200"){
                        ...
                        that.$router.push('/pages/usernearV3')
                    }
            ...
            //职业显示
            showJobBottom:function() {
                this.bottomJob=true
            },
            hideJobBottom:function() {
                this.bottomJob=false
            },
            onCancelJob:function(){
                this.hideJobBottom()
            },
            onConfirmJob: function (value) {
                console.log(value)
                this.job = value
                this.hideJobBottom()
                this.onChange(value)
